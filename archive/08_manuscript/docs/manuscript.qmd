...
* Salmon cohorts were put out in annually Spring, on day `r unique(farm_coords$t_start[farm_coords$lat < 0])` when farm latitude < 0 and day `r unique(farm_coords$t_start[farm_coords$lat > 0])` when farm latitude > 0.
...
```{r biomass produced, class.chunk = "aside"}
