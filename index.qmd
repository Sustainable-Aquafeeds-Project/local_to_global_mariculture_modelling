...
|:--------------------------|:----------:|:----------:|:----------:|:----------:|:----------:|
| Salmon biomass produced (t) | `r bpr1$PD` | `r bpr1$MD` | `r bpr1$NI` | `r bpr2$MD` | `r bpr2$NI` |
| Feed provided (t) | `r fpr1$PD` | `r fpr1$MD` | `r fpr1$NI` | `r fpr2$MD` | `r fpr2$NI` |
| Feed provided (kg/kg salmon) | `r fpr_pb1$PD` | `r fpr_pb1$MD` | `r fpr_pb1$NI` | `r fpr_pb2$MD` | `r fpr_pb2$NI` |
| Uneaten feed (t) | `r tuf1$PD` | `r tuf1$MD` | `r tuf1$NI` | `r tuf2$MD` | `r tuf2$NI` |
| Excreted waste (t) | `r tew1$PD` | `r tew1$MD` | `r tew1$NI` | `r tew2$MD` | `r tew2$NI` |
| Total waste (E+U, t) | `r tow1$PD` | `r tow1$MD` | `r tow1$NI` | `r tow2$MD` | `r tow2$NI` |
| Proportion of total waste composed of excretion (%) | `r epw$PD` | `r epw$MD` | `r epw$NI` |  |  |
| Total protein waste (t) | `r sum(plc1$PD_P)` | `r sum(plc1$MD_P)` | `r sum(plc1$NI_P)` | `r plc3$MD_P` | `r plc3$NI_P` |
| Total carbohydrate waste (t) | `r sum(plc1$PD_C)` | `r sum(plc1$MD_C)` | `r sum(plc1$NI_C)` | `r plc3$MD_C` | `r plc3$NI_C` |
| Total lipid waste (t) | `r sum(plc1$PD_L)` | `r sum(plc1$MD_L)` | `r sum(plc1$NI_L)` | `r plc3$MD_L` | `r plc3$NI_L` |
...
| Total N from uneaten feed (t) | `r niu1$PD` | `r niu1$MD` | `r niu1$NI` | `r niu2$MD` | `r niu2$NI` |
| Total N from excreted waste (t) | `r nie1$PD` | `r nie1$MD` | `r nie1$NI` | `r nie2$MD` | `r nie2$NI` |
| Total N inputs (E+U, t) | `r nit1$PD` | `r nit1$MD` | `r nit1$NI` | `r nit2$MD` | `r nit2$NI` |
: Summary of all results. Unless otherwise specified, values presented are means across all farms, summed across a single production period. Some cells of this table are blank - sometimes that means it doesn't make sense to fill that cell, but sometimes it means I haven't got to it yet. {#tbl-results-summary}

So here are the major themes I'm getting from @tbl-results-summary:
