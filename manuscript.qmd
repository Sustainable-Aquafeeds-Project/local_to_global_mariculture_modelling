...
* The reference feed is `r filter(feed_summary, feed == "reference", macro == "P")$total_r`% protein, `r filter(feed_summary, feed == "reference", macro == "L")$total_r`% lipid, `r filter(feed_summary, feed == "reference", macro == "C")$total_r`% carbohydrate.
* The past feed is `r filter(feed_summary, feed == "past", macro == "P")$total_r`% protein, `r filter(feed_summary, feed == "past", macro == "L")$total_r`% lipid, `r filter(feed_summary, feed == "past", macro == "C")$total_r`% carbohydrate.
* The future feed is `r filter(feed_summary, feed == "future", macro == "P")$total_r`% protein, `r filter(feed_summary, feed == "future", macro == "L")$total_r`% lipid, `r filter(feed_summary, feed == "future", macro == "C")$total_r`% carbohydrate.
* Within the reference feed, protein is overall `r filter(feed_summary, feed == "reference", macro == "P")$digest_r`% digestible, lipid is overall `r filter(feed_summary, feed == "reference", macro == "L")$digest_r`% digestible, and carbohydrate is overall `r filter(feed_summary, feed == "reference", macro == "C")$digest_r`% digestible.
* Within the past feed, protein is overall `r filter(feed_summary, feed == "past", macro == "P")$digest_r`% digestible, lipid is overall `r filter(feed_summary, feed == "past", macro == "L")$digest_r`% digestible, and carbohydrate is overall `r filter(feed_summary, feed == "past", macro == "C")$digest_r`% digestible.
* Within the future feed, protein is overall `r filter(feed_summary, feed == "future", macro == "P")$digest_r`% digestible, lipid is overall `r filter(feed_summary, feed == "future", macro == "L")$digest_r`% digestible, and carbohydrate is overall `r filter(feed_summary, feed == "future", macro == "C")$digest_r`% digestible.

```{r feed summary ideas}
#| fig-cap: | 
...
* but slightly less uneaten feed was lost in the reference scenario. Uneaten past feed ranged from 
