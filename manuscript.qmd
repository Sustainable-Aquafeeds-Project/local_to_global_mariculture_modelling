...
* Used the full population of 5000 for the population parameters $\overline{W}$, $\Delta{W}$, $\overline{I_{max}}$, $\Delta{I_{max}}$, $\overline{F}$, and $\Delta{F}$, and a population of 100 in each farm for all other parameters.
...
* Within the past feed, protein is overall `r round(100*digestP_2,1)`% digestible, lipid is overall `r round(100*digestL,1)`% digestible, and carbohydrate is overall `r round(100*digestC_2,1)`% digestible.
* Within the future feed, protein is overall `r round(100*digestP_3,1)`% digestible, lipid is overall `r round(100*digestL,1)`% digestible, and carbohydrate is overall `r round(100*digestC_3,1)`% digestible.
...
|:-----------:|:---:|:---:|:---:|
| Protein | `r tP_1` |  `r tP_2` |  `r tP_3` | 
| Lipids | `r tL_1` | `r tL_2` |  `r tL_3` | 
| Carbohydrates | `r tC_1` | `r tL_2` |  `r tL_3` | 
